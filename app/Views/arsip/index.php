...
<body>
    ...
    <main>
        <!-- Hero -->
        <!-- <section class="section text-white" style="background-image: url('assets/img/kelurahan.jpg');"> -->
        <section class="text-white" style="background-image: url('assets/img/kelurahan.jpg');">
            <div style="background-color: rgba(0, 0, 0, 0.5);">
                <div class="container">
                    <div class="row justify-content-center p-3">
                        <div class="col-12 text-center">
                            <img src="assets/img/logo-kelurahan.svg" width="100" alt="">
                            <h1 class="fw-bolder pt-3">Arsip Desa Karangduren</h1>
                            <h4 class="fw-bolder px-lg-8">Kelurahan Pakisaji</h4>
                        </div>
                    </div>
    ...
    <footer class="footer py-3 bg-gray-800 text-white">
        <div class="text-center" role="contentinfo">
            <p class="fw-normal font-small mb-0">Adine Pramesti G © <span class="current-year">2021</span>. All rights reserved.</p>
            </div>
        </div>
    <div class="container">
        <div class="row">
